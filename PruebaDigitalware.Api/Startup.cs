...
using PruebaDigitalware.Data.RepoData;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace PruebaDigitalware.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           options => options.UseSqlServer(Configuration.GetConnectionString("ConnectionMain")));
            ...
            services.AddScoped<IClienteData, ClienteData>();
            services.AddScoped<IProductoData, ProductoData>();
            services.AddScoped<IFacturaData, FacturaData>();
            services.AddScoped<IFacturaProductoData, FacturaProductoData>();

            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "PruebaDigitalware.Api", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "PruebaDigitalware.Api v1"));
            }
